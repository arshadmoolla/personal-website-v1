...
<html lang="en">
  <head>
    <title>Message Sent! | Website Design and Development - Arshad Moolla</title>
    <meta charset="UTF-8">
  ...
  <body>
    <div class="wrapper">
      ...
      <?php
        ...
        echo "<p style='color:#3a4061; text-align:center; font-size:26px; font-family:Raleway, sans-serif; padding:25px 7px 5px 7px;'>" . "Thank you for contacting." . "</p>" ;
        echo "<p style='color:#3a4061; text-align:center; font-size:20px; font-family:Raleway, sans-serif; padding:0px 7px 0px 7px;'>" . "I will get back to you soon!" . "</p>" ;
