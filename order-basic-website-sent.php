  ...
  <body>
    <div class="wrapper">
      ...
      <?php
        ...
        $subject = "Basic Website Package Order From " . $name;
        $mailheader = "From: $email \r\n";
        mail($recipient, $subject, $formcontent, $mailheader) or die("Error!");
        echo "<p style='color:#3a4061; text-align:center; font-size:26px; font-family:Raleway, sans-serif; padding:25px 7px 5px 7px;'>" . "Thank you for ordering the Basic Website Package." . "</p>" ;
